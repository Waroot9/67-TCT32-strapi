...
const key = Buffer.from(process.env.SECRET_CODE); // Should be a 32-byte key for aes-256
const iv = process.env.SECRET_CODE_2; // Should be a 16-byte IV for aes-256-cbc
